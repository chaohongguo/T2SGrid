...
def load_json_dataset(
    train_data_path, eval_data_path, video_folder, preprocessed_data_path=None
...
QUESTION_TEMPLATE = """During which frames can we see [EVENT]? Answer in the format of 'from x to y'"""
    ...
    messages.append(
        {
            ...
            "content": [
                ...
                {
                    "type": "text",
                    "text": QUESTION_TEMPLATE.replace("[EVENT]", example["problem"]),
                },
            ],
        }
    )
